...
const formattedDate = date.toLocaleDateString('en-GB', options);
    ...
    <div className="bg-[#FEFEFE] w-full h-[280px] rounded-lg dark:bg-[#1E2A47] flex flex-row">
        <div className="w-1/4 h-full">
        <div className="bg-yellow-500 rounded-full overflow-hidden h-20 max-w-20 mt-6 ml-8">
        ...
        <div className="w-full h-[45%] flex flex-col">
            ...
            <h2 className="text-[12px] text-[#5C7B9D] dark:text-[#FEFEFE] mt-4">{bio || "Not available"}</h2>
        </div>
        <div className="bg-[#F6F8FF] dark:dark:bg-[#141D2F]  w-[95%] h-[25%] rounded-md mr-9 flex justify-center items-center space-x-4 p-6 mt-4">
        ...
        <div className="w-full h-[30%] grid grid-cols-2 gap-x-8 pt-2 pb-3 text-[#5C7B9D] dark:text-[#FEFEFE]">
  ...
  <a href={blog} target="_blank" rel="noopener noreferrer">
    <p className="text-[10px] text-blue-500">{blog || "Not available"}</p>
  </a>
</div>
            <div className="flex space-x-3">
